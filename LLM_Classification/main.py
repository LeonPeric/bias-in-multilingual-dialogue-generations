...
pre_text = "Can you determine which topic the following text is discussing? The topics are: 1. Care 2. Sympathy 3. Patronising 4. Disbelief 5. Curiosity 6. None of the above. The text is: "
for model in models:
    results = []
    for language in languages:
    ...
    with open(f"../templates/topic_labeling_{model}.pkl", "wb") as f:
